...
import {changesForReferrer} from '../components/FunctionsForReferrer/functionForReferrer'
...
export default function redirection(
    ...
    const widgetRefferer = changesForReferrer(getHostName(document.referrer));
